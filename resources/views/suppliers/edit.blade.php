...
<head>
    ...
    <title>Edit Supplier - Mofu Cafe Admin</title>
...
<body>
    ...
    <main class="main-content">
        <h1 style="font-family: 'Mochiy Pop One'; color: var(--mofu-dark);">Edit Supplier</h1>
        <p class="text-muted">Update supplier data for {{ $supplier->supplier_name }}.</p>
            ...
            <div class="card-body p-4">
                <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('supplier_name') is-invalid @enderror" name="supplier_name" value="{{ old('supplier_name', $supplier->supplier_name) }}" placeholder="Masukkan Nama Supplier">
                        @error('supplier_name')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('contact_name') is-invalid @enderror" name="contact_name" value="{{ old('contact_name', $supplier->contact_name) }}" placeholder="Masukkan Nama Kontak Person">
                                @error('contact_name')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone', $supplier->phone) }}" placeholder="Masukkan Nomor Telepon">
                                @error('phone')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror" name="address" rows="4" placeholder="Masukkan Alamat Lengkap Supplier">{{ old('address', $supplier->address) }}</textarea>
                        @error('address')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror" name="notes" id="notes" rows="5" placeholder="Masukkan Catatan Tambahan">{{ old('notes', $supplier->notes) }}</textarea>
                        @error('notes')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>

                    <button type="submit" class="btn btn-primary me-3" style="background-color: var(--mofu-pink); border: none;">UPDATE SUPPLIER</button>
                    <a href="{{ route('suppliers.index') }}" class="btn btn-warning" style="background-color: var(--mofu-orange); border: none;">CANCEL</a>
                </form>
            </div>
        </div>
    </main>
